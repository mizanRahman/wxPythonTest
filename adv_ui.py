...
class Reader(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        toolbar.AddLabelTool(1, 'File', wx.Bitmap('icons/mozilla.png'))
        toolbar.AddLabelTool(2, 'Edit', wx.Bitmap('icons/gnome.png'))
        toolbar.AddLabelTool(3, 'Tools', wx.Bitmap('icons/stock_exit.png'))
        toolbar.AddLabelTool(4, 'Exit', wx.Bitmap('icons/stock_exit.png'))
        toolbar.Realize()

        self.Bind(wx.EVT_TOOL, self.ExitApp, id=1)
        self.Bind(wx.EVT_TOOL, self.EditApp, id=2)
